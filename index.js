...
const QUICKNODE_RPC = "https://indulgent-greatest-hexagon.solana-devnet.discover.quiknode.pro/85abf8f5168b9cd31741d788b6fcbee44eafee29/"
...
const METAPLEX = Metaplex.make(SOLANA_CONNECTION)
    ...
    async function main() {
        ...
        const metadataUri = await uploadMetadata(imgUri,
            CONFIG.imgType, CONFIG.imgName, CONFIG.description, CONFIG.attributes );
